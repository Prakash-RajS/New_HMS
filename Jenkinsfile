...
sudo cp -r ${FRONTEND_DIR}/${FRONTEND_BUILD}/* /var/www/hms_frontend
...
echo "✅ Deployment Complete — Backend + Frontend live"
EOF
                    """
                }
            }
        ...
        success {
            emailext(
                ...
                body: """
                    ...
                    <p>NGINX + Django restarted successfully.</p>
