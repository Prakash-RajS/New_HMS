...
#             data={**invoice_data, "redirect_to": "/billing-page"}
#         )
...
from Fastapi_app.services.websocket_service import notify_clients  # Use this instead of manager.broadcast
...
class NotificationService:
    ...
    async def send_notification(
        ...
        # Use notify_clients instead of manager.broadcast
    ...
    # Keep all your specific methods - they now use the permission-based system
    @staticmethod
    async def send_appointment_created(appointment, staff, department):
        await NotificationService.send_notification(
            event_type="appointment_created",
