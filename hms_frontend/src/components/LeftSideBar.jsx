...
export default function Sidebar() {
  return (
    <div className="w-[230px] h-[872px] mt-[90px] ml-[15px]  rounded-[20px] border border-[#1E1E1E] bg-[#0D0D0D] shadow-[0px_0px_12px_0px_#FFFFFF1F] flex flex-col justify-between p-4 fixed">
      <ul className="flex flex-col gap-2 mt-4 text-[14px] text-left font-normal font-['Inter']">
        {menuItems.map((item, idx) => (
          <NavLink
            key={idx}
            to={item.path}
