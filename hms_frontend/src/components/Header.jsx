...
import { searchMenu } from "./SearchMenu"; // Import search logic
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-gray-600 dark:text-gray-400 whitespace-nowrap">Admin</span>
              </div>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={`text-gray-600 dark:text-gray-400 group-hover:text-[#08994A] dark:group-hover:text-emerald-400 transition-colors shrink-0 ${isDropdownOpen ? "rotate-180" : ""}`}>
