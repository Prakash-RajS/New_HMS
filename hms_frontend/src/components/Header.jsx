...
const Header = () => {
    return (
        <header className="flex items-center justify-end p-4 bg-black text-white gap-[20px]">
            {/* Search Box - Moved to align with icons */}
            <div className="relative w-[394px] h-[42px]">
                {/* Search Icon */}
