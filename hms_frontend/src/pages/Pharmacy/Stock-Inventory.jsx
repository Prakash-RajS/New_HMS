...
const validateVendorIdFormat = (value, currentVendorName = "", currentId = null) => {
  ...
  const trimmedId = value.trim().toLowerCase(); // ← lowercase for comparison
  ...
  const vendorNameConflict = inventoryData.some(item => {
    ...
    return (
      ...
      item.vendorCode.trim().toLowerCase() !== trimmedId  // ← case-insensitive
    );
  });
  ...
  if (vendorIdConflict) {
    const existingEntry = inventoryData.find(item =>
      item.vendorCode.trim().toLowerCase() === trimmedId &&
      item.vendor.trim().toLowerCase() !== trimmedVendorName &&
      (currentId ? item.id !== currentId : true)
    );
    return `Vendor ID "${value.trim()}" is already used by "${existingEntry?.vendor}".`;
  }
...
const validateQuantityFormat = (value) => {
  ...
  if (!value || value.trim() === "") return "Add Quantity is required";
...
const validateShelfNoFormat = (value) => {
  ...
  const validateRequiredFields = (formData, isEditForm = false) => {
    ...
    if (!isEditForm) {
      ...
      // For edit form, add_quantity is required
      if (!formData.add_quantity || formData.add_quantity.trim() === "") {
        errors.add_quantity = "Add Quantity is required";
      }
    }
...
case "status":
  ...
  const handleEditStock = async (e) => {
    ...
    // Check required fields (including add_quantity)
              ...
              <form onSubmit={handleAddStock} noValidate>
                <div className="grid grid-cols-4 gap-x-6 gap-y-5">
                  ...
                  <div>
                    ...
                    />
                    <CharacterCount current={newStock.product_name.length} max={FIELD_LIMITS.product_name} />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-[36px] px-3 rounded-[8px] border border-gray-300 dark:border-[#3A3A3A] bg-gray-100 dark:bg-transparent text-black dark:text-[#0EFF7B] placeholder-gray-400 dark:placeholder-gray-500 outline-none focus:border-[#0EFF7B] transition"
                    />
                    <CharacterCount current={newStock.dosage.length} max={FIELD_LIMITS.dosage} />
                  ...
                  <div>
                    ...
                    />
                    <CharacterCount current={newStock.batch_number.length} max={FIELD_LIMITS.batch_number} />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-[36px] px-3 rounded-[8px] border border-gray-300 dark:border-[#3A3A3A] bg-gray-100 dark:bg-transparent text-black dark:text-[#0EFF7B] outline-none focus:border-[#0EFF7B] transition"
                    />
                    <CharacterCount current={newStock.vendor.length} max={FIELD_LIMITS.vendor} />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-[36px] px-3 rounded-[8px] border border-gray-300 dark:border-[#3A3A3A] bg-gray-100 dark:bg-transparent text-black dark:text-[#0EFF7B] outline-none focus:border-[#0EFF7B] transition"
                    />
                    <CharacterCount current={newStock.vendor_id.length} max={FIELD_LIMITS.vendor_id} />
      ...
      {fieldErrors.quantity}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-[36px] px-3 rounded-[8px] border border-gray-300 dark:border-[#3A3A3A] bg-gray-100 dark:bg-transparent text-black dark:text-[#0EFF7B] outline-none focus:border-[#0EFF7B] transition"
                    />
                    <CharacterCount current={newStock.item_code.length} max={FIELD_LIMITS.item_code} />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-[36px] px-3 rounded-[8px] border border-gray-300 dark:border-[#3A3A3A] bg-gray-100 dark:bg-transparent text-black dark:text-[#0EFF7B] outline-none focus:border-[#0EFF7B] transition"
                    />
                    <CharacterCount current={newStock.rack_no.length} max={FIELD_LIMITS.rack_no} />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-[36px] px-3 rounded-[8px] border border-gray-300 dark:border-[#3A3A3A] bg-gray-100 dark:bg-transparent text-black dark:text-[#0EFF7B] outline-none focus:border-[#0EFF7B] transition"
                    />
                    <CharacterCount current={newStock.shelf_no.length} max={FIELD_LIMITS.shelf_no} />
    ...
    Current stock will be increased by this amount (max 99,999)
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-[36px] px-3 rounded-[8px] border border-gray-300 dark:border-[#3A3A3A] bg-gray-100 dark:bg-transparent text-black dark:text-[#0EFF7B] outline-none focus:border-[#0EFF7B] transition"
                    />
                    <CharacterCount current={editStock.rack_no.length} max={FIELD_LIMITS.rack_no} />
                    {validationErrors.rack_no && (
                      <p className="mt-1 text-[12px] text-[#FF2424]">
                        {validationErrors.rack_no}
                      </p>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-[36px] px-3 rounded-[8px] border border-gray-300 dark:border-[#3A3A3A] bg-gray-100 dark:bg-transparent text-black dark:text-[#0EFF7B] outline-none focus:border-[#0EFF7B] transition"
                    />
                    <CharacterCount current={editStock.shelf_no.length} max={FIELD_LIMITS.shelf_no} />
                    {validationErrors.shelf_no && (
                      <p className="mt-1 text-[12px] text-[#FF2424]">
                        {validationErrors.shelf_no}
                      </p>
