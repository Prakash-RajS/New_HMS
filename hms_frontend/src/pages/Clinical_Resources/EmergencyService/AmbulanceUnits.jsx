...
//   // Validate phone number - must be exactly 10 digits when stripped
...
//   // Check if two phone numbers are the same (after stripping formatting)
...
//     // Only compare if both have 10 digits
...
//   // Validation rules - validates for BOTH create and edit modes
...
//       case "phone":
//         // Phone is REQUIRED for both create and edit modes
//         return validatePhoneNumber(value, true);
        
//       case "contact_number":
//         // Contact number is optional, but validate if provided
//         const contactError = validatePhoneNumber(value, false);
//         if (contactError) return contactError;
        
//         // Check if contact number is same as primary phone
//         if (value && allFields.phone && arePhoneNumbersSame(value, allFields.phone)) {
//           return "Alternate contact cannot be same as primary phone number";
//         }
//         return "";
...
//         // Also clear contact_number error if it's related to phone comparison
//         if (name === 'phone' || name === 'contact_number') {
...
//       // If phone or contact_number changed, re-validate the other to check for duplicates
//       if (name === 'phone' && updatedForm.contact_number) {
//         const contactError = validateField('contact_number', updatedForm.contact_number, updatedForm);
//         if (contactError) {
//           setErrors(prevErrors => ({
//             ...prevErrors,
...
//       if (name === 'contact_number' && updatedForm.phone) {
//         const contactError = validateField('contact_number', newValue, updatedForm);
//         if (contactError) {
//           setErrors(prevErrors => ({
//             ...prevErrors,
//             contact_number: contactError
...
//           // Show toast for each duplicate error
