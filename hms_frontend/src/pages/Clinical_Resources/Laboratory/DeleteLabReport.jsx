  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 z-50">
      ...
      <div
        ...
        bg-gradient-to-r from-red-400/70 via-gray-300/30 to-red-400/70
        dark:bg-[linear-gradient(132.3deg,rgba(255,77,77,0.7)_0%,rgba(30,30,30,0.7)_49.68%,rgba(255,77,77,0.7)_99.36%)]"
      >
        {/* Inner Container */}
        <div
          className="w-[505px] h-auto rounded-[19px] bg-white dark:bg-[#000000] text-black dark:text-white p-6 relative"
