    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 z-50">
      ...
      backdrop-blur-md relative">
        ...
        <div className="grid grid-cols-2 gap-6">
          {/* Name */}
          <div>
            <label className="text-sm text-black dark:text-white">Donor Name</label>
            <input
              name="name"
              value={formData.name}
          ...
          {/* Donation Date */}
          <div>
            <label className="text-sm text-black dark:text-white">Donation Date</label>
            <div className="relative">
              ...
              />
              {errors.donationDate && <p className="text-red-500 dark:text-red-400 text-xs mt-1">{errors.donationDate}</p>}
            </div>
          </div>
        </div>
