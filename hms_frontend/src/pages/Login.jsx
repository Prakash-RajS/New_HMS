...
// };
  ...
  return (
    <>
      ...
      <div className={`fixed inset-0 z-0 pointer-events-none overflow-hidden ${isLightMode ? 'bg-white' : 'bg-black'}`}>
        {Array.from({ length: 200 }).map((_, i) => {
          ...
          return (
            <motion.div
              key={i}
              className={`absolute w-1 h-1 rounded-full ${isLightMode ? 'bg-[#0EFF7BCC]' : 'bg-white'}`}
      ...
      <div className={`flex flex-col md:flex-row w-screen h-full ${isLightMode ? 'bg-white' : 'bg-black'}`}>
        {/* Left Side */}
        ...
        <div className="w-full md:w-1/2 h-auto flex items-center justify-center relative">
          <motion.div
            className={`border-[1.5px] mr-12 rounded-[12px] p-8 flex flex-col items-center relative ${isLightMode ? 'bg-white border-[#0EFF7B] shadow-[0px_0px_50px_0px_#0EFF7B40]' : 'bg-black border-[#0EFF7B33]'}`}
          ...
          >
            {/* Welcome Text */}
            <motion.h1
              className={`text-[32px] font-bold mb-2 text-center ${isLightMode ? 'text-black' : 'text-white'}`}
            ...
            <motion.p
              className={`text-[18px] mb-8 text-center ${isLightMode ? 'text-[#08994A]' : 'text-gray-300'}`}
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <form className="flex flex-col gap-4" onSubmit={handleLogin}>
              ...
              <style>{`
                input:-webkit-autofill {
                  -webkit-box-shadow: 0 0 0px 1000px ${isLightMode ? '#0EFF7B1A' : '#0EFF7B1A'} inset !important;
              ...
              >
                <label htmlFor="username" className={`font-medium mb-1 ${isLightMode ? 'text-gray-700' : 'text-gray-400'}`}>
                  Username
                </label>
                <input
                  type="text"
                  ...
                  className={`min-w-[500px] h-[51px] rounded-[8px] px-3 py-2  focus:outline-none focus:bg-[#0EFF7B1A] transition-all duration-300 hover:border-[#0EFF7B] border border-transparent ${isLightMode ? 'text-[#00E569E5] placeholder-[#00E569E5] bg-[#0EFF7B1A]' : 'text-white placeholder-gray-400 bg-[#0EFF7B1A]'}`}
                  value={username}
              ...
              >
                <label htmlFor="password" className={`font-medium mb-1 ${isLightMode ? 'text-gray-700' : 'text-gray-400'}`}>
                  Password
                </label>
                <div className="relative">
                  <input
                    ...
                    className={`min-w-[500px] h-[51px] rounded-[8px] px-3 py-2 bg-[#0EFF7B1A] focus:outline-none focus:bg-[#0EFF7B1A] pr-10 transition-all duration-300 hover:border-[#0EFF7B] border border-transparent ${isLightMode ? 'text-[#00E569E5] placeholder-[#00E569E5]' : 'text-white placeholder-gray-400'}`}
                    value={password}
              ...
              >
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="remember" className={`${isLightMode ? 'text-gray-700' : 'text-gray-400'}`}>
                    Remember me
                  </label>
                </div>
              </motion.div>
