...
const AppointmentList = () => {
  ...
  return (
    <div className="bg-black text-white rounded-xl p-6 w-[1100px] mx-auto">
      {/* Header */}
      ...
      {/* Filters */}
      <div className="w-[1100px] h-[57px] rounded-[40px] border border-[#0EFF7B1A] bg-[#0D0D0D] flex items-center justify-between px-10 mb-4">
        {filters.map((f) => (
          <button
            key={f}
