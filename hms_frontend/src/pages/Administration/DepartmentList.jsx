...
const DepartmentList = () => {
  ...
  const handleBulkStatusChange = useCallback(
    ...
    [selectedDepartments, updateDepartmentStatus, canCRUD]
  );
     ...
     bg-gray-100 dark:bg-transparent overflow-hidden relative font-[Helvetica]"
      >
        ...
        <div className="flex justify-between items-center mt-4 mb-2">
          ...
          {/* ✅ Add Department — admin only with tooltip */}
        ...
        {/* ✅ Change Status Dropdown — admin only with tooltip */}
        <div className="flex items-center mb-4">
          <div className="flex items-center mr-4 relative w-5 h-5">
            <input
              type="checkbox"
        ...
        <div className="flex gap-4 mb-4 justify-end">
          ...
          >
            ...
            <span
              ...
              px-3 py-1 text-xs rounded-md shadow-md
              bg-gray-100 dark:bg-black text-black dark:text-white opacity-0
              group-hover:opacity-100 transition-all duration-150 z-50"
            >
              Filter
            </span>
          </button>
          ...
          <table className="w-full text-left text-sm min-w-[600px]">
            ...
            <tbody className="bg-gray-100 dark:bg-black border-b border-gray-300 dark:border-gray-600">
              {currentDepartments.length > 0 ? (
                currentDepartments.map((dept, idx) => {
                  const IconComponent =
                    departmentIcons[dept.name] || Activity;
                  const dropdownPosition = getDropdownPosition(idx);
                  return (
                    <tr
                      key={dept.id}
                    ...
                    >
                      ...
                      {/* ✅ Action column — Edit & Delete with tooltip like IPD */}
                      <td className="text-center px-4 relative">
                        <div
                          className="cursor-pointer flex justify-center"
                          onClick={() =>
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 z-[50]">
            <div className="relative w-[504px] border-[#0EFF7B] rounded-[20px] bg-gray-100 dark:bg-[#000000E5] text-black dark:text-white p-6">
                ...
                <div>
                  ...
                  >
                    <div className="relative w-full min-w-0">
                      ...
                      <Listbox.Options className="absolute mt-1 w-full rounded-[12px] bg-gray-100 dark:bg-black shadow-lg z-[60] border border-[#0EFF7B] dark:border-[#3A3A3A] max-h-60 overflow-y-auto left-0 no-scrollbar">
                        {[5, 6, 7, 8, 9, 10, 11, 12].map((option) => (
                          <Listbox.Option
                            key={option}
                            value={option}
              ...
              <div className="flex justify-center gap-6 mt-8">
                ...
                <button
                  onClick={applySettings}
                  className="w-[144px] h-[33px] rounded-[8px] border-b-[2px] border-[#0EFF7B] dark:border-[#0EFF7B66] px-3 py-2 shadow text-white font-medium text-[14px] leading-[16px] hover:scale-105 transition"
                  style={{
                    background:
                      "linear-gradient(92.18deg, #025126 3.26%, #0D7F41 50.54%, #025126 97.83%)",
                  }}
