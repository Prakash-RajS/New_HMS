...
const RoomManagement = () => {
  ...
  return (
    <div className="mt-[60px] h-100% mb-4 bg-black text-white rounded-xl p-6 w-full max-w-[1400px] mx-auto">
      <div className="mt-[60px] mb-4 bg-black text-white rounded-xl p-6">
        {/* Header */}
        ...
        <p className="text-gray-400 mb-2">You have total 7 types bed group.</p>
        ...
        <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex items-center gap-3">
             ...
             checked:before:text-sm"
              ...
              <button 
                ...
                className={`px-4 h-[40px] rounded-full text-sm border ${
                  isBedListRoute 
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 border border-gray-700 rounded-full px-3 py-1 w-[300px]">
          ...
          <Route path="bed-list" element={
            <div>
              ...
              <div className="text-center py-10 text-white">
                <h3 className="text-xl font-semibold mb-4">Bed List View</h3>
                <p className="text-gray-400">This is the Bed List page content.</p>
                <button 
                  onClick={handleRoomManagementClick}
                  className="mt-4 px-4 py-2 bg-green-500 text-black rounded-full hover:bg-green-600"
                >
