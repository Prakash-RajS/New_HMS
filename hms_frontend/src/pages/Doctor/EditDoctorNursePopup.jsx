...
const EditDoctorNursePopup = ({ onClose, profile, onUpdate }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 z-50">
      <div className="w-[504px] h-[520px] rounded-[20px] border border-[#1E1E1E] bg-[#000000E5] text-white p-6 shadow-[0px_0px_4px_0px_rgba(255,255,255,0.12)] backdrop-blur-md relative">
        {/* Header */}
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          {/* Joining Date */}
          <div>
            <label className="text-sm text-white">Joining Date</label>
