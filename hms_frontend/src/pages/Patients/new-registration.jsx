...
const PhotoUploadBox = ({ photo, setPhoto }) => {
  ...
  return (
    <div>
      ...
      <label
        htmlFor="photoUpload"
        className="border-2 border-dashed border-gray-600 w-32 h-36 
  ...
  <div className="space-y-1">
    ...
    <Listbox value={value} onChange={onChange}>
      <div className="relative">
        <Listbox.Button
          className="w-full h-[42px] px-3 pr-8 rounded-full border border-[#3A3A3A]
...
const InputField = ({ label, name, value, onChange, placeholder }) => (
  <div className="space-y-1">
    ...
    <input
      ...
      className="w-full h-[42px] px-3 rounded-full border border-[#3A3A3A] 
...
export default function NewRegistration({ isSidebarOpen }) {
  ...
  const sidebarWidth = isSidebarOpen ? 280 : 10; // Assuming 250px open, 60px closed

  return (
    <div className="relative">
      <div
        className="flex-1 bg-black mt-[90px] mb-4 p-6 text-white rounded-xl w-full"
        style={{
          marginLeft: `${sidebarWidth}px`,
          transition: "margin-left 0.8s ease", // Smooth transition for sidebar toggle
          maxWidth: `calc(100vw - ${sidebarWidth}px)`, // Ensure it fills available space
          minWidth: "1380px", // Prevent form from becoming too narrow
          height: "auto",
        }}
      >
        {/* Back Button */}
          ...
          <div className="md:col-span-3">
            ...
            <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <div>
                ...
                <div className="mt-4">
                  ...
                  <textarea
                    ...
                    className="w-full h-20 mt-1 px-3 py-2 rounded-lg border border-[#3A3A3A] bg-transparent text-[#0EFF7B] placeholder-gray-500 outline-none"
                  />
                </div>
              </div>
              ...
              <div className="flex justify-end gap-4">
                <button
                  type="reset"
                  className="px-6 py-2 rounded-lg border border-gray-600 text-gray-400 hover:text-white"
                  onClick={() => {
                    setFormData({});
                    setPhoto(null);
                  }}
