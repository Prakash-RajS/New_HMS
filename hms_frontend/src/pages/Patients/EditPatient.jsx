...
const EditAppointmentPopup = ({ onClose, appointment, onUpdate }) => {
    ...
    <div>
      ...
      <Listbox value={value} onChange={onChange}>
        <div className="relative mt-1 w-[228px]">
          ...
          <Listbox.Options
            className="absolute mt-1 w-full rounded-[12px] bg-white dark:bg-black shadow-lg z-50 border border-[#0EFF7B] dark:border-[#3A3A3A] left-[2px]"
          >
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 z-50">
      <div className="w-[504px] h-[485px] rounded-[20px] border border-[#0EFF7B] dark:border-[#1E1E1E] bg-white dark:bg-[#000000E5] text-black dark:text-white p-6 shadow-[0px_0px_4px_0px_rgba(255,255,255,0.12)] backdrop-blur-md relative">
        {/* Header */}
        <div className="flex justify-between items-center pb-3 mb-4">
          ...
          <button
            onClick={onClose}
            className="w-6 h-6 rounded-full border border-[#0EFF7B] dark:border-[#0EFF7B1A] bg-white dark:bg-[#0EFF7B1A] shadow flex items-center justify-center hover:bg-[#0EFF7B1A] dark:hover:bg-[#0EFF7B1A] hover:text-[#08994A] dark:hover:text-white"
          >
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          {/* Appointment Date */}
          <div>
            <label className="text-sm text-black dark:text-white">Appointment Date</label>
        ...
        <div className="flex justify-center gap-[18px] mt-8">
          ...
          <button
            ...
            className="w-[104px] h-[33px] rounded-[20px] border border-[#0EFF7B] dark:border-[#0EFF7B66] bg-gradient-to-r from-[#0EFF7B] to-[#08994A] dark:from-[#14DC6F] dark:to-[#09753A] shadow text-white font-medium text-[14px] leading-[16px] opacity-100 hover:scale-105 transition"
          >
            Update
          </button>
        </div>
