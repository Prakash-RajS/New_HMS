...
const AppointmentListIPD = () => {
  ...
  return (
    <div className="mt-[60px] h-auto mb-4 bg-white dark:bg-black text-black dark:text-white dark:border-[#1E1E1E] rounded-xl p-6 w-full max-w-[1400px] mx-auto">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-semibold text-black dark:text-white">IPD - Patient Lists</h2>
         <button
              ...
              currentAppointments.map((appt, idx) => {
                ...
                return (
                  <tr key={globalIndex} className="border-b border-gray-300 dark:border-gray-800">
                    ...
                    <td className="text-black dark:text-white">{appt.discharge}</td>
                    <td>
                      <span
  ...
  <input
    ...
    onChange={handleFilterChange}
    className="w-[250px] h-[33px] mt-1 pl-3 rounded-full border 
               border-[#0EFF7B] dark:border-[#3A3A3A] 
               bg-white dark:bg-transparent text-[#08994A] dark:text-[#0EFF7B] 
               outline-none appearance-none"
  />
  {/* ✅ Fix: icon is centered inside input */}
  <Calendar className="absolute right-3 top-1/2 -translate-y-1/2 text-[#08994A] dark:text-[#0EFF7B] w-4 h-4 pointer-events-none" />
</div>
            </div>
